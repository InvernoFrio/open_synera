...
namespace Engine {
    ...
    void VulkanOverlayPipeline::Init(
        VkDevice device,
        VkExtent2D extent,
        ...
        auto vertCode =
            VulkanShader::ReadFile(
                "assets/shaders/overlay.vert.spv"
            );
        ...
        */
        ...
        if (vkCreatePipelineLayout(
            ...
            throw std::runtime_error(
                "Failed to create overlay pipeline layout"
            );
        }
        ...
        if (vkCreateGraphicsPipelines(
            ...
            throw std::runtime_error(
                "Failed to create overlay pipeline"
            );
        }
    ...
    void VulkanOverlayPipeline::Shutdown() {
    ...
    VkPipeline VulkanOverlayPipeline::GetPipeline() const {
        return m_Pipeline;
    }

    VkPipelineLayout VulkanOverlayPipeline::GetPipelineLayout() const {
